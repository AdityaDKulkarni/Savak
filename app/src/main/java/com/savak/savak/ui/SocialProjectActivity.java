...
public class SocialProjectActivity extends BaseActivity {
    ...
    private void initui() {
        ...
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(rvSocialProject.getContext(),
                new LinearLayoutManager(this).getOrientation());
        rvSocialProject.addItemDecoration(dividerItemDecoration);
        ...
        if (getIntent().hasExtra("library")) {
            ...
            tvtitle2.setText(getString(R.string.social_projects));
